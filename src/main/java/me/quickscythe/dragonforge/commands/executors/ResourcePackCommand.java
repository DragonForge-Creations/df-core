...
public class ResourcePackCommand extends CommandExecutor {
    ...
    public LiteralCommandNode<CommandSourceStack> execute() {
        return literal(getName()).executes(context -> showUsage(context, "df.admin.resourcepack")).then(argument("action", StringArgumentType.string()).suggests((context, builder) -> {
